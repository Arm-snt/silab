      ...
      <MuiThemeProvider theme={theme}>
        ...
        <Grid container>
          <Switch>
            ...
            <Route path="/usuario/detalles" exact component={DetallesUsuario} ></Route> <Route path="/usuario/editar" exact component={UsuarioEditar} ></Route>
            <Route path="/estudiantes" exact component={Estudiantes}></Route>
            <Route path="/estudiante/update" exact component={UpdateEstudiante} ></Route> <Route path="/laboratorios" exact component={Laboratorios}></Route>
