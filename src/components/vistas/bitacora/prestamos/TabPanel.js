        ...
        <Paper className={classes.paper}>
          <div className={classes.root}>
            <Tabs value={value} onChange={handleChange} indicatorColor="primary" textColor="primary" >
              <Tab label="Prestamos" {...a11yProps(0)} />
              <Tab label="Nuevo Prestamo" {...a11yProps(1)} />
              <Tab label="Detalles Prestamo" {...a11yProps(2)} disabled/>
              <Tab label="Editar Prestamo" {...a11yProps(3)} disabled/>
            </Tabs>
            <SwipeableViews
